    ...
    <footer className="bg-charcoal-900 text-cream-100">
      ...
      <div className="container-wide py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-8">
          {/* Left Navigation */}
          <nav className="flex flex-col space-y-3 text-center lg:text-left">
            {footerNavLeft.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-caption uppercase tracking-widest text-cream-300 hover:text-sepia-400 transition-colors duration-300"
              >
                {item.label}
              </Link>
            ))}
          ...
          {/* Right Navigation */}
          <nav className="flex flex-col space-y-3 text-center lg:text-right">
      ...
      <div className="border-t border-charcoal-800">
        <div className="container-wide py-12 text-center">
          ...
          >
            <span className="text-lg font-serif text-cream-300 group-hover:text-sepia-400 transition-colors">
              Contact Us
            </span>
            <motion.span
