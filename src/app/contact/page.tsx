          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            >
              ...
              <p className="text-body-lg text-charcoal-600 font-light mb-10">
                ...
                I'm here to help you preserve your most meaningful moments. Fill out 
                the form and I'll be in touch within 48 hours.
              </p>
              ...
              <div className="space-y-6 mb-12">
                <div>
                  ...
                  <a
                    href={`mailto:${sampleSiteConfig.contact_email}`}
                    className="text-charcoal-800 hover:text-sepia-600 transition-colors"
                  >
                    {sampleSiteConfig.contact_email}
                  </a>
                </div>
                <div>
                  <p className="text-caption uppercase tracking-widest text-sepia-600 mb-1">
                  ...
                  <p className="text-charcoal-800">
                    Phoenix, Arizona — Available Worldwide
                  </p>
                </div>
              </div>
